...
export function Sidebar({ className, currentView, setView }: SidebarProps) {
    ...
    return (
        <div className={cn("pb-12 w-64 border-r border-slate-800 h-[calc(100vh-3.5rem)] bg-slate-950/50 hidden md:block", className)}>
            <div className="space-y-4 py-4">
                ...
                <div className="px-3 py-2">
                    <div className="px-4 py-4 rounded border border-slate-800/50 bg-slate-900/20 mx-2">
