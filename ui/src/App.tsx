  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-emerald-500/30">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur h-14 shrink-0 px-6 flex items-center justify-between">
          <div className="flex items-center gap-2 md:hidden">
            <div className="w-3 h-3 bg-emerald-500 rounded-full animate-pulse" />
            <h1 className="font-bold tracking-tight text-lg">CATALYST</h1>
          </div>

          <div className="flex items-center gap-4 ml-auto">
            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900 border border-slate-800 shadow-sm">
        ...
        <main className="flex-1 p-6 overflow-y-auto bg-slate-950">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            {currentView === "workflows" && (
              <div className="flex items-center justify-center h-[500px] border border-dashed border-slate-800 rounded bg-slate-900/20">
